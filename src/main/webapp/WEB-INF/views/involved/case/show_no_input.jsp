            ...
            <tr>
                <td align="center">
                    ...
                    <sys:permission url="<%=Url.getUrl(Url.INVOLVED_CASE_SYNC_SHOW)%>">
                        <a href="${root}<%=Url.getUrl(Url.INVOLVED_CASE_SYNC_SHOW)%>?caseid=${item.caseid}" class="btn btn-blue" data-id="sync" data-toggle="navtab" data-mask="true" data-width="600" data-height="500"  data-title="同步财务">同步财务</a>
                    </sys:permission>
