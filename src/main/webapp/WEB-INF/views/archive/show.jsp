                            ...
                            <tr>
                                <td class="option">
                                    <a href="${root}<%=Url.getUrl(Url.ARCHIVE_DETAIL_SHOW)%>?id=${item.id}"
                                       class="btn btn-green" data-toggle="dialog" data-mask="true" data-width="900"
                                       data-height="500" data-max="true" data-confirm-msg="详情">详情</a>
                                    <a href="${root}<%=Url.getUrl(Url.ARCHIVE_UPDATE_SHOW)%>?id=${item.id}"
                                       class="btn btn-blue" data-toggle="dialog" data-mask="true" data-width="700"
