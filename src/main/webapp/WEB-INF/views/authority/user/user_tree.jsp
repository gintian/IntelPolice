...
<script>
    function getName(userId,userName) {
        $.CurrentNavtab.find("#userTree_userId").val(userId);
        $.CurrentNavtab.find("#userTree_userName").val(userName);
       parent.window.document.getElementById("userTree_userId").value=userId;
       parent.window.document.getElementById("userTree_userName").value=userName;
    }
...
<div class="bjui-pageContent tableContent">
   ...
   table-top data_table table_center" data-selected-multi="true" id="bt">
        ...
        <c:forEach items="${list}" var="item">
            <tr>
                <td><a onclick="getName('${item.id}','${item.name}')" class="btn btn-close"
