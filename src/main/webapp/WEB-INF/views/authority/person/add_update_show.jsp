                        ...
                        <label  class="col-md-4">人大代表：</label>
                            <div class="col-md-8">
                                <label class="radio-inline">
                                    ...
                                    <input  type="radio" name="isrddb" class="form-control" value="0" ${entity.isrddb eq "0" ? "checked" : "" } >&nbsp; &nbsp; 否
                                </label>
                                <label class="radio-inline">
                                    <input  type="radio" name="isrddb"  class="form-control" value="1" ${empty entity.isrddb or entity.isrddb eq "1" ? "checked" : "" } > &nbsp; &nbsp;是
                                </label>
                            </div>
                    </div>
                    <div class="form-group">
