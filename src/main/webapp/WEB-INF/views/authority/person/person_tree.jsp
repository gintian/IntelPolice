...
<script>
    function getName(personId,name) {
        ...
        parent.window.document.getElementById("recordPerson_personId").value=personId;
        parent.window.document.getElementById("ecordPerson_name").value=name;
    }
</script>
<div class="bjui-pageHeader" style="height: 90px">
  <form id="${searchFormId}" data-toggle="ajaxsearch"
        action="${root}<%=Url.getUrl(Url.RECORD_PERSON_TREE_SHOW)%>" method="post">
