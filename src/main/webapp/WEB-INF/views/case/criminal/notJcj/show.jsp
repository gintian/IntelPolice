...
<div class="bjui-pageHeader">
    <form id="${searchFormId}" data-toggle="ajaxsearch"
          action="${root}<%=Url.getUrl(Url.CRIMINAL_NOTJCJ_PAGE_SHOW)%>" method="post">
        ...
        <c:forEach items="${list}" var="item">
            <tr>
                <td class="option" align="center">
                    <sys:permission url="<%=Url.getUrl(Url.CRIMINAL_NOTJCJ_DETAIL_SHOW)%>">
                        <a href="${root}<%=Url.getUrl(Url.CRIMINAL_NOTJCJ_DETAIL_SHOW)%>?caseid=${item.caseid}"
