                ...
                <div id="layout-01" style="height:94%; overflow:hidden;">
                    ...
                    <table class="table table-bordered table-hover table-striped table-top data_table table_center"
                        ...
                        <tr class="line_top">
                            ...
                            <th align="center">财物编码</th>
                            <th align="center">财物名称</th>
                            <th align="center">登记时间</th>
                            <th align="center">财物分类</th>
                            <th align="center">财物物主</th>
                            <th align="center">是否经过保管审批</th>
                            <th align="center">保管到期时间</th>
                            <th align="center">财物是否涉案</th>
                        </tr>
                        </thead>
                        <tbody>
                        <c:forEach items="${list}" var="item">
                            <tr>
                                ...
                                <td title="${item.cwbm}" align="center"><hs:out value="${item.cwbm}" length="5"/></td>
                                <td title="${item.cwmc}" align="center"><hs:out value="${item.cwmc}"/></td>
                                <td><hs:datefmt value="${item.djsj}" stringDatePatten="dateTimeFormat"/></td>
                                <td title="${item.cwflCode}" align="center"><hs:involvedType value="${item.cwflCode}"/></td>
                                <td title="${item.cwwz}" align="center"><hs:out value="${item.cwwz}"/></td>
