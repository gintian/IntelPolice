...
<div class="bjui-pageHeader">
    <form id="${searchFormId}" data-toggle="ajaxsearch" action="${root}<%=Url.getUrl(Url.ARCHIVE_NO_INPUT_SHOW)%>" method="post">
        ...
        <c:forEach items="${list}" var="item">
            <tr>
                <td align="center">
                    ...
                    <sys:permission url="<%=Url.getUrl(Url.ARCHIVE_INFOS_CASE_SHOW)%>">
                            <a href="${root}<%=Url.getUrl(Url.ARCHIVE_INFOS_CASE_SHOW)%>?caseId=${item.caseid}" class="btn btn-blue" data-toggle="navtab" data-mask="true" data-width="600" data-height="500"  data-confirm-msg="同步卷宗">同步卷宗</a>
                    </sys:permission>
                </td>
                ...
                <td></td><td></td>
                    ...
                    <%--<td title="${item.unitname}"><hs:out value="${item.dqbldw}" length="10"/></td>--%><%--unitname--%>
