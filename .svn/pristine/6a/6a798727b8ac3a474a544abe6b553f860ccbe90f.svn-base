...
public class DESEncrypt {
	...
	public static byte[] encrypt(byte[] src, byte[] key) throws Exception {
		...
		/**
		*
		* @param pass<a href="http://www.it165.net/edu/ebg/" target="_blank" class="keylink">word</a> 密码
		* @param key 加密字符串
		* @return
		*/
...
//
//		System.out.println(DESEncrypt.encrypt("111111", "tltest01" + CommonConstant.USER_PASSWORD_SALT));
//
//	}
}
