...
function loop() {
    ...
    function  btn_click(){
        button.on('click',function () {
            ...
            $('<tr class="question"><th>问：</th><td>'+li_content.text()+'</td><td><input class="btn btn-danger delete" type="button" value="删除"></td></tr><tr class="answer">' +
    ...
    function delete_btn_click() {
        ...
        $('table[id=editor_table]').on('click','.delete',function () {
