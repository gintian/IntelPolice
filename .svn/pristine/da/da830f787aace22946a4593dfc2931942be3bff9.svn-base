...
<div class="bjui-pageContent tableContent">
    <%--<%@ include file="/WEB-INF/views/common/_page_left_dept1.jsp" %>--%>
                ...
                <div id="layout-01" style="height:94%; overflow:hidden;">
                    <div class="bjui-pageHeader">
                        <form id="pagerForm" data-toggle="ajaxsearch"
                              action="${root}<%=Url.getUrl(Url.JD_CASE)%>" method="post">
                            ...
                            <c:forEach items="${list}" var="item">
                                <tr>
                                    <td class="option" align="center"><a
                                            href="${root}<%=Url.getUrl(Url.ABNORMAL_CONFIRM_DETAIL_SHOW)%>?caseid=${item.caseid}"
