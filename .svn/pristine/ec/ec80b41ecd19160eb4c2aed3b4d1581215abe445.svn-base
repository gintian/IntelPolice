...
<div class="bjui-pageHeader">
    <form id="pagerForm" data-toggle="ajaxsearch"
          action="${root}<%=Url.getUrl(Url.JD_MESSAGE)%>?status=${status}" method="post">
...
<div class="bjui-pageContent tableContent">
    <table class="table table-bordered table-hover table-striped table-top data_table table_center"
        ...
        <tr class="line_top">
            ...
            <th width="80" align="center">接收人ID</th>
            <th width="90" align="center">接收人姓名</th>
            <th width="80" align="center">操作人ID</th>
            <th width="90" align="center">操作人姓名</th>
        ...
        <c:forEach items="${list}" var="item">
            ...
            <td><hs:out value="${item.receiveUserId}"/></td>
            <td align="center"><hs:out value="${item.receiveUserName}"/></td>
