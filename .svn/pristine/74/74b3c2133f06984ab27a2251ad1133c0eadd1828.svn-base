...
<div class="panel panel-primary">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading">
            ...
            <sys:permission url="<%=Url.getUrl(Url.INVOLVED_TEMP_CASE_PAGE_SHOW)%>">
                <a href="${root}<%=Url.getUrl(Url.INVOLVED_TEMP_CASE_PAGE_SHOW)%>?caseid=${criminalBean.caseid}"
                   class="btn btn-blue"  data-toggle="dialog" data-mask="true" data-width="800" data-height="600" data-options="{id:'archiveAdd',onClose:function(){opener.location.reload()}}">财务同步</a>
            </sys:permission>
        </div>
        <!-- Table -->
